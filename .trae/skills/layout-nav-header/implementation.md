...
```bash
npm install vue-router @iconify/vue
```

### 路由配置

在路由配置文件中，将 MainLayout 设置为父路由：
...
/* 配色方案 */
.sidebar {
  background: linear-gradient(180deg, #1e3a5f 0%, #0f1f33 100%); /* 修改渐变色 */
}

.logo-icon {
  color: #4fc3f7; /* 修改 Logo 颜色 */
}
```
